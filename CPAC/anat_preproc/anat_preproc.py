...
def freesurfer_postproc(wf, cfg, strat_pool, pipe_num, opt=None):
    ...
    {"name": "freesurfer_postproc",
     ...
     "outputs": ["pipeline-fs_space-T1w_desc-brain_mask", 
                 ...
                 "pipeline-fs_label-CSF_mask", "label-CSF_mask",
                 "pipeline-fs_label-WM_mask", "label-WM_mask",
                 "pipeline-fs_label-GM_mask", "label-GM_mask"
                ]}
    '''
...
#     '''
#     {"name": "postproc_prep",
#      "config": ["anatomical_preproc", "freesurfer_outputs"],
#      "switch": ["run"],
#      "option_key": "None",
#      "option_val": "None",
...
# def ingress_reconall(wf, cfg, strat_pool, pipe_num, opt=None):
#     {"name": "ingress_reconall",
#      "config": ["surface_analysis", "freesurfer"],
#      "switch": ["ingress_reconall"],
#      "option_key": "None",
#      "option_val": "None",
#      "inputs": [("desc-acpcbrain_T2w",
#                  "desc-preproc_T2w",
